...
<Box position="relative">
  {cart.length > 0 && (
    <Box position="absolute" top="-2" right="-2" bg="red" borderRadius="full" w="1.5rem" h="1.5rem" textAlign="center">
      <Text fontSize="sm" fontWeight="bold" color="black">{cart.length}</Text>
    </Box>
  )}
</Box>
